...
class SlashCommand:
    ...
    function: Callable[[types.Program, types.InteractionHistory, Sequence[str]], SlashCommandResult]


    ### implementations ###

def slash_traceback(prog: types.Program, interaction: types.InteractionHistory, args: Sequence[str]) -> SlashCommandResult:
...
def slash_save(prog: types.Program, interaction: types.InteractionHistory, args: Sequence[str]) -> SlashCommandResult:
...
def try_command(prog: types.Program, interaction: types.InteractionHistory, input_line: str) -> SlashCommandResult:
    ...
    try:
        ...
        # log it and move on
        logger.debug(f"shlex got value error while parsing arguments to slash command. Reason: {e}")
